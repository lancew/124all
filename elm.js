...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{next: $author$project$Main$One, phase: $author$project$Main$Ready, status: false, timer: 60},
...
var $author$project$Main$ChangePhase = function (a) {
	return {$: 'ChangePhase', a: a};
};
var $author$project$Main$changePhase = function (stage) {
	switch (stage.$) {
		case 'One':
			return $author$project$Main$ChangePhase($author$project$Main$One);
		case 'Two':
			return $author$project$Main$ChangePhase($author$project$Main$Two);
		case 'Four':
			return $author$project$Main$ChangePhase($author$project$Main$Four);
		case 'All':
			return $author$project$Main$ChangePhase($author$project$Main$All);
		default:
			return $author$project$Main$ChangePhase($author$project$Main$Ready);
	}
};
		...
		switch (msg.$) {
			case 'Start':
				return A3(
					...
					$author$project$Main$changePhase($author$project$Main$One),
					_Utils_Tuple2(
						_Utils_update(
							model,
							{status: true}),
				...
				switch (stage.$) {
					case 'One':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{next: $author$project$Main$Two, phase: $author$project$Main$One, timer: 60}),
							$elm$core$Platform$Cmd$none);
					case 'Two':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{next: $author$project$Main$Four, phase: $author$project$Main$Two, timer: 120}),
							$elm$core$Platform$Cmd$none);
					case 'Four':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{next: $author$project$Main$All, phase: $author$project$Main$Four, timer: 240}),
							$elm$core$Platform$Cmd$none);
					case 'All':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{next: $author$project$Main$All, phase: $author$project$Main$All, timer: 300}),
							$elm$core$Platform$Cmd$none);
					default:
						...
						switch (_v2.$) {
							case 'Two':
								return A3(
									$ccapndave$elm_update_extra$Update$Extra$andThen,
									$author$project$Main$update,
									$author$project$Main$changePhase($author$project$Main$Two),
									_Utils_Tuple2(
										_Utils_update(
											model,
											{timer: 1}),
							...
							case 'Four':
								return A3(
									$ccapndave$elm_update_extra$Update$Extra$andThen,
									$author$project$Main$update,
									$author$project$Main$changePhase($author$project$Main$Four),
									_Utils_Tuple2(
										_Utils_update(
											model,
											{timer: 1}),
							...
							case 'All':
								return A3(
									$ccapndave$elm_update_extra$Update$Extra$andThen,
									$author$project$Main$update,
									$author$project$Main$changePhase($author$project$Main$All),
									_Utils_Tuple2(
										_Utils_update(
											model,
											{timer: 1}),
		...
		[
			...
			_List_fromArray(
				[
					...
					{
						label: $mdgriffith$elm_ui$Element$text('https://lancew.github.io/124all/'),
						url: 'https://lancew.github.io/124all/'
					})
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					...
					{
						label: $mdgriffith$elm_ui$Element$text('By Lance Wicks: https://github.com/lancew/124all'),
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight]),
					{
						label: $mdgriffith$elm_ui$Element$text('Based on ideas in Liberating Structures'),
						url: 'http://www.liberatingstructures.com/1-1-2-4-all/'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight]),
					{
						label: $mdgriffith$elm_ui$Element$text('and Hyper Island'),
						url: 'https://toolbox.hyperisland.com/1-2-4-all'
					})
				]))
		]));
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText($author$project$Main$One)
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText($author$project$Main$Two)
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText($author$project$Main$Four)
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText($author$project$Main$All)
							]))
					]));
		case 'One':
			return A2(
...
var $author$project$Main$statusButtons = function (model) {
	return model.status ? A2(
		...
		}) : (_Utils_eq(model.phase, $author$project$Main$Ready) ? A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
