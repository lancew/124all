...
{
	if (region.a6.as === region.bp.as)
	{
		return 'on line ' + region.a6.as;
	}
	return 'on lines ' + region.a6.as + ' through ' + region.bp.as;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dd: 'hidden', cT: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dd: 'mozHidden', cT: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dd: 'msHidden', cT: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dd: 'webkitHidden', cT: 'webkitvisibilitychange' }
		: { dd: 'hidden', cT: 'visibilitychange' };
}
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bZ: processes, ce: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.ce);
		if (_v0.$ === 1) {
...
var $author$project$Main$PhaseAll = {$: 6};
var $author$project$Main$PhaseFour = {$: 5};
var $author$project$Main$PhaseOne = {$: 3};
var $author$project$Main$PhaseTwo = {$: 4};
...
var $jxxcarlson$elm_typed_time$TypedTime$Seconds = 1;
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {cq: 'a', aP: 'atv', ct: 'ab', cu: 'cx', cv: 'cy', cw: 'acb', cx: 'accx', cy: 'accy', cz: 'acr', be: 'al', bf: 'ar', cA: 'at', aQ: 'ah', aR: 'av', cC: 's', cG: 'bh', cH: 'b', cJ: 'w7', cL: 'bd', cM: 'bdt', aA: 'bn', cN: 'bs', aB: 'cpe', cV: 'cp', cW: 'cpx', cX: 'cpy', O: 'c', aD: 'ctr', aE: 'cb', aF: 'ccx', P: 'ccy', ar: 'cl', aG: 'cr', cY: 'ct', c_: 'cptr', c$: 'ctxt', da: 'fcs', bt: 'focus-within', db: 'fs', dc: 'g', aW: 'hbh', aX: 'hc', bz: 'he', aY: 'hf', bA: 'hfp', de: 'hv', dg: 'ic', di: 'fr', aI: 'lbl', dk: 'iml', dl: 'imlf', dm: 'imlp', dn: 'implw', $7: 'it', dq: 'i', bL: 'lnk', ak: 'nb', bO: 'notxt', dE: 'ol', dF: 'or', ab: 'oq', dK: 'oh', bS: 'pg', bT: 'p', dL: 'ppe', dP: 'ui', b3: 'r', dR: 'sb', dS: 'sbx', dT: 'sby', dU: 'sbt', dW: 'e', dX: 'cap', dY: 'sev', d1: 'sk', a9: 't', d5: 'tc', d6: 'w8', d7: 'w2', d8: 'w9', d9: 'tj', aN: 'tja', ea: 'tl', eb: 'w3', ec: 'w5', ed: 'w4', ee: 'tr', ef: 'w6', eg: 'w1', eh: 'tun', cg: 'ts', af: 'clr', en: 'u', ba: 'wc', cl: 'we', bb: 'wf', cm: 'wfp', bc: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.O);
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bS);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bT);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b3);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dW);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.I)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dZ.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dZ.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.b3) + ('-' + ($elm$core$String$fromInt(pos.bm) + ('-' + ($elm$core$String$fromInt(pos.ck) + ('-' + $elm$core$String$fromInt(pos.by)))))));
		case 11:
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.de, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.da, $mdgriffith$elm_ui$Internal$Style$classes.ab)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aP, $mdgriffith$elm_ui$Internal$Style$classes.af)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b3) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b3) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cC) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.aD) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aC: closing, o: _List_Nil, U: _List_Nil, G: selector};
	});
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.G + ('{' + (renderValues(rule.U) + (rule.aC + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.b3;
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.b3) + ';'),
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.b3) + (' / ' + ($elm$core$String$fromInt(position.b3 + position.by) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.bm) + (' / ' + ($elm$core$String$fromInt(position.bm + position.ck) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.b3) + ('-' + ($elm$core$String$fromInt(position.bm) + ('-' + ($elm$core$String$fromInt(position.ck) + ('-' + $elm$core$String$fromInt(position.by)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dX + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.a9 + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dX + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.a9)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {by: height / size, am: size, ci: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cS, adjustment.cF, adjustment.c1, adjustment.ds]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dW))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.aD, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cz])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.aD, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cx])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.aD, $mdgriffith$elm_ui$Internal$Style$classes.cy])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.aD, $mdgriffith$elm_ui$Internal$Style$classes.cw])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ba + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aX)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.cC + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.a9 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bb + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aY)))));
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.cU)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.cU)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.cq]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.cH]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.dF]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.dE]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.di]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ak, $mdgriffith$elm_ui$Internal$Style$classes.dW, $mdgriffith$elm_ui$Internal$Style$classes.cG]));
						}
					}())
				]),
			_List_fromArray(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.cC + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.O + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.cC + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.b3 + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cY + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ar)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.cM);
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aF + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
		...
		[
			...
			_List_fromArray(
				[
					...
					{
						_: $mdgriffith$elm_ui$Element$text('https://lancew.github.io/124all/'),
						aO: 'https://lancew.github.io/124all/'
					})
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					...
					{
						_: $mdgriffith$elm_ui$Element$text('By Lance Wicks: https://github.com/lancew/124all'),
						aO: 'https://github.com/lancew/124all'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight]),
					{
						_: $mdgriffith$elm_ui$Element$text('Based on ideas in Liberating Structures'),
						aO: 'http://www.liberatingstructures.com/1-1-2-4-all/'
					}),
					A2(
					$mdgriffith$elm_ui$Element$link,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$alignRight]),
					{
						_: $mdgriffith$elm_ui$Element$text('and Hyper Island'),
						aO: 'https://toolbox.hyperisland.com/1-2-4-all'
					})
				]))
		]));
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('1-2-4-All Timer'))
		]));
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{da: $elm$core$Maybe$Nothing, de: $elm$core$Maybe$Nothing, du: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dP, $mdgriffith$elm_ui$Internal$Style$classes.cC, $mdgriffith$elm_ui$Internal$Style$classes.dW]))),
...
var $author$project$Main$phaseText = function (phase) {
	switch (phase) {
		case 'Ready':
			return A2(
				$mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText('One')
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText('Two')
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText('Four')
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$author$project$Main$phaseText('All')
							]))
					]));
		case 'One':
			return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('1 : Silent self-reflection by individuals on a shared challenge, framed as a question (e.g., What opportunities do YOU see for making progress on this challenge? How would you handle this situation? What ideas or actions do you recommend?)')
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('(1 minute)')
									]))
							]))
					]));
		case 'Two':
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('2: Generate ideas in pairs, building on ideas from self-reflection.')
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('(2 Minutes)')
									]))
							]))
					]));
		case 'Four':
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('4: Share and develop ideas from your pair in foursomes (notice similarities and differences).')
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('(4 minutes)')
									]))
							]))
					]));
		case 'All':
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('All: Ask, “What is one idea that stood out in your conversation?” Each group shares one important idea with all.')
									]))
							])),
						A2(
						$mdgriffith$elm_ui$Element$column,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('(5 minutes)  repeat as needed')
									]))
							]))
					]));
		default:
...
var $phollyer$elm_ui_colors$Color$White$seashell = A3($mdgriffith$elm_ui$Element$rgb255, 255, 245, 238);
var $jxxcarlson$elm_typed_time$TypedTime$TypedTime = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $jxxcarlson$elm_typed_time$TypedTime$seconds = function (t) {
	return A2($jxxcarlson$elm_typed_time$TypedTime$TypedTime, 1, 1000 * t);
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aF + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bO)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Main$statusButtons = function (model) {
	return model.ae ? A2(
		...
		_List_Nil,
		{
			_: $mdgriffith$elm_ui$Element$text('Stop'),
			a1: $elm$core$Maybe$Just($author$project$Main$Stop)
		}) : ((model.S === 'Ready') ? A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
			_: $mdgriffith$elm_ui$Element$text('Start'),
			a1: $elm$core$Maybe$Just($author$project$Main$Start)
		}) : A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
			_: $mdgriffith$elm_ui$Element$text('Start'),
			a1: $elm$core$Maybe$Just($author$project$Main$Restart)
		}));
};
...
var $jxxcarlson$elm_typed_time$TypedTime$hmStringFromSeconds = function (s) {
	...
	return A3(
		...
		2,
		'0',
		$elm$core$String$fromInt(tr.Q)) + (':' + A3(
		$elm$core$String$padLeft,
		2,
		'0',
		$elm$core$String$fromInt(tr.D)));
};
...
var $jxxcarlson$elm_typed_time$TypedTime$hmsStringFromSeconds = function (s) {
	...
	return A3(
		...
		2,
		'0',
		$elm$core$String$fromInt(tr.D)) + (':' + A3(
		$elm$core$String$padLeft,
		2,
		'0',
		$elm$core$String$fromInt(tr.al)))));
};
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					cB: 0,
					d0: _List_fromArray(
						[$phollyer$elm_ui_colors$Color$White$seashell, $phollyer$elm_ui_colors$Color$White$whitesmoke])
				})
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
						...
						[
							...
							$mdgriffith$elm_ui$Element$text(
								A2(
									...
									1,
									$jxxcarlson$elm_typed_time$TypedTime$seconds(model.r))))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$author$project$Main$phaseText(model.S)
						])),
					$author$project$Main$footer
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{dj: $author$project$Main$init, d2: $author$project$Main$subscriptions, eo: $author$project$Main$update, ep: $author$project$Main$view});
